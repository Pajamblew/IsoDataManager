...
namespace IsoDataManager
{
    public class Settings
    {
        ...
        public static int BlockCount = 24;
        public static readonly string[] Names = new string[24]
        {
      "LYNX_PWR",
      "LYNX_CONTR",
      ...
      "LYNX_EUR_ADDERCHART*",
      "EMEA-I_NV_REVTABLE",
      "EMEA-I_NV_TITLE_BLOCK",
      "LYNX_CALCULATION",
      "LYNX_CONSTRUCTION_NOTE_RU-EN",
      "LYNX_CONSTRUCTION_NOTE",
      "REV_TABLE",
      "BDR_TitleBlock"
